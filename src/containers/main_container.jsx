                            ...
                            <div className="profile__rss-feed-toolbar">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <button class="dropdown-item" type="button" onClick={() => this.sortStories('title')}>Title</button>
                                        <button class="dropdown-item" type="button" onClick={() => this.sortStories('date')}>Published Date</button>
                                        <button class="dropdown-item" type="button" onClick={() => this.sortStories('description')}>Description</button>
                                    </div>
                                </div>
                            </div>
                            <div className="profile__rss-feed-list">
                                { this.renderStories(this.state.article_history) }
                            </div>
                        </div> 
                    </div>  
                </section>
